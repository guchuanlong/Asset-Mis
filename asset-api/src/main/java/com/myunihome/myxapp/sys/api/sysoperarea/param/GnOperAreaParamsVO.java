 ...
 * @author jiaxs
 */
public class GnOperAreaParamsVO extends BaseInfo implements Serializable {
     ...
     * 分页信息
     */
    private PageInfo<GnOperAreaVO> pageInfo;
    ...
    public PageInfo<GnOperAreaVO> getPageInfo() {
        return pageInfo;
    }

    public void setPageInfo(PageInfo<GnOperAreaVO> pageInfo) {
