 ...
 * @author liangbs
 */
public class GnStaffNoParamsVO extends BaseInfo implements Serializable {
     ...
     * 分页信息
     */
    private PageInfo<GnStaffNoVO> pageInfo;
    ...
    public PageInfo<GnStaffNoVO> getPageInfo() {
        return pageInfo;
    }

    public void setPageInfo(PageInfo<GnStaffNoVO> pageInfo) {
