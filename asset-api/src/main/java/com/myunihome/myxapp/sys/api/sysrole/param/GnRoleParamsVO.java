...
public class GnRoleParamsVO extends BaseInfo implements Serializable {
     ...
     * 过滤的角色id集
     */
    private List<Long> filterRoleIdList;
    
    /**
     * 分页信息
     */
    private PageInfo<GnRoleVO> pageInfo;
    ...
    public PageInfo<GnRoleVO> getPageInfo() {
        return pageInfo;
    }

    public void setPageInfo(PageInfo<GnRoleVO> pageInfo) {
        this.pageInfo = pageInfo;
    }

	public List<Long> getFilterRoleIdList() {
		return filterRoleIdList;
	}

	public void setFilterRoleIdList(List<Long> filterRoleIdList) {
		this.filterRoleIdList = filterRoleIdList;
	}
}