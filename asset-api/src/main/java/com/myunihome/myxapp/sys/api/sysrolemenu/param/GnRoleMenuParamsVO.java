 ...
 * @author liangbs
 */
public class GnRoleMenuParamsVO extends BaseInfo implements Serializable {
     ...
     * 分页信息
     */
    private PageInfo<GnRoleMenuVO> pageInfo;
    ...
    public PageInfo<GnRoleMenuVO> getPageInfo() {
        return pageInfo;
    }

    public void setPageInfo(PageInfo<GnRoleMenuVO> pageInfo) {
